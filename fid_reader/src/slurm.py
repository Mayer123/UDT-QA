...
def init_distributed_mode(params):
    ...
    # multi-GPU job (local or multi-node) - jobs started with torch.distributed.launch
        ...
        print("Setting up context with torch.distributed parameters.")
        ...
        print("global_rank", os.environ["RANK"])
        print("word_size", os.environ['WORLD_SIZE'])
        print("ngpu", os.environ['NGPU'])
