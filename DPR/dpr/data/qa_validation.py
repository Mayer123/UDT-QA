...
def calculate_matches(
    ...
    if workers_num > 1:
        ...
        logger.info("Single Process Matching answers in top docs...")
        scores = [check_answer(qad, match_type=match_type, tokenizer=tokenizer) for qad in questions_answers_docs]
